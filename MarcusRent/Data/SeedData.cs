...
public static async Task InitializeAsync(IServiceProvider serviceProvider)
{
    ...
    var users = new List<ApplicationUser>();  // Samla användare för order-seed
    ...
    // 5. Skapa ordrar (seeda)

    if (!context.Orders.Any())
    {
        var allUsers = users; // användare vi seedat ovan
        ...
        var orders = new List<Order>
        {
            ...
            {
                Customer = allUsers[0],
                Cars = new List<Car> { allCars[0], allCars[1] },
            ...
            {
                Customer = allUsers[2],
                Cars = new List<Car> { allCars[3], allCars[4] },
            ...
            {
                Customer = allUsers[1],
                Cars = new List<Car> { allCars[0], allCars[4] },
